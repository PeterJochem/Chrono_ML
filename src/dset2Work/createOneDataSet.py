...
dataDirectory = "../../dataSets/dset2/allData/"
...
listOfFiles = ["A1.csv",  "A2.csv", "A3.csv", 
                "B1.csv", "B2.csv", "B3.csv",
                "C1.csv", "C2.csv", "C3.csv",
                "D1.csv", "D2.csv", "D3.csv",
                "E1.csv", "E2.csv", "E3.csv",
                "F1.csv", "F2.csv", "F3.csv",
                "G1.csv", "G2.csv", "G3.csv",
                "H1.csv", "H2.csv", "H3.csv",
                "I1.csv", "I2.csv", "I3.csv",
                "J1.csv", "J2.csv", "J3.csv",
                "K1.csv", "K2.csv", "K3.csv",
                "L1.csv", "L2.csv", "L3.csv",
